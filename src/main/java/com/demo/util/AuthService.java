...
public class AuthService {
    ...
    private static final String APP_ID = "11264831";
    private static final String API_KEY = "LdPPlGBPDqGuDv8O0zr2dMgC";
    private static final String SECRET_KEY = "8xhGjvXXzC2eG8ukqaAP4SF09pdGWBgw";
    ...
    public static String getAuth() {
        ...
        String clientId = "LdPPlGBPDqGuDv8O0zr2dMgC";
        // 官网获取的 Secret Key 更新为你注册的
        String clientSecret = "8xhGjvXXzC2eG8ukqaAP4SF09pdGWBgw";
